...
\journal{Journal of Informatics and Computer Science Intelligent Systems Applications. }
...
\cortext[cor1]{Corresponding author, Corner of East Tamaki Road and, Newbury St, Otara, Auckland 2023, New Zealand}
%\fntext[fn1]{footnote info for Fadi}

\author[firuz.address]{Firuz Kamalov}
%\ead{firuz.kamalov@cud.ac.ae}
%\fntext[fn2]{footnote info for Firuz}

\author[suhel.address]{Suhel Hammoud}
%\ead{suhel.hammoud@uok.edu.sy}
%\fntext[fn3]{footnote info for Suhel}

\author[syed.address]{Syed Reza Shahamiri}
%\ead{suhel.hammoud@uok.edu.sy}
%\fntext[fn4]{footnote info for Syed}
...
% Line numbers in review edition TODO remove it later
\linenumbers
